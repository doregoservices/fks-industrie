...
- **Produits = ventes + variations de stocks valorisées** : ventes du mois **+ variation du stock de café torréfié** (au coût moyen du vert — c'est le maillon qui répare le résultat : torréfier sans conditionner ne charge plus rien, le café passe en stock) **+ variation du stock de produits finis** (au coût de revient) + semi-finis (historique). Chaque kg de café est compté **une seule fois** : chargé à la torréfaction → actif torréfié → actif conditionné → encaissé à la vente. Un résultat ne peut plus « dépasser les ventes » par la magie de la comptabilité.
