...
4. **Production — saisie unique** : 🌱 vert → 🔥 torréfaction → ⚙️ **Transformation & Conditionnement en une saisie** : le torréfié consommé + les unités produites ; l'app calcule le café conditionné, la **perte** et le **rendement** (ex. 100 kg → 95 kg conditionnés = 5 kg de perte, 95 %). Les emballages sont consommés automatiquement. Option repliée « peser le café en vrac » pour ceux qui transforment en deux temps. Tout est modifiable (✎).
