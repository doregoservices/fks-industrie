...
4. **Production — un seul pesage** : 🌱 **le café vert est pesé avant torréfaction — c'est la SEULE pesée de l'usine**. 🔥 Torréfaction : le torréfié obtenu est facultatif (non pesé → estimé à 82 %). ⚙️ **Transformation & Conditionnement en une saisie** : le torréfié consommé est facultatif ; on compte les **unités produites**, l'app en déduit le café conditionné. 📈 **Baromètre usine** affiché en haut de l'écran Production : rendement global vert → produits finis (30 derniers jours). Pesées toujours possibles (champs facultatifs) pour un suivi plus fin. Tout est modifiable (✎).
